...
> line 276 counts the number of times each word appears per president. 277 groups that output by the president. 278 creates a new column called n_tot, which is the total number of words
