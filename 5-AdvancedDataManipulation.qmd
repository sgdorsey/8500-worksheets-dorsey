...
```
Dr. Regan, please read this: I tried to save this to a variable and it wouldn't save to the variable, then it kept running this for a solid 2 minutes, so I left it alone after this. Can we please go over this in class?
